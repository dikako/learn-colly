...
func main() {
	...
	c := colly.NewCollector(
		...
		// Cache responses to prevent multiple download og pages
	...
	c.OnHTML("a[href]", func(e *colly.HTMLElement) {
		...
		// If link start with browse or include either signup or login return from callback
	...
	c.OnHTML(`a.collection-product-card`, func(e *colly.HTMLElement) {
		// Activate detailCollector if the link contains "coursera/learn"
	...
	// Dump json to the standart output
	enc.Encode(courses)
}
